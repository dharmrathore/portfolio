        ...
        <section className='flex items-center flex-wrap md:flex-row'>
            <div className='w-full md:w-4/12 flex flex-col gap-4'>
                ...
                <ul className='flex items-center gap-4 flex-wrap justify-center'>
                    <li>
                        <Link href="#" rel='facebook' className='border rounded-md w-10 h-10 items-center justify-center flex hover:bg-[#1f436e] hover:text-white'>
