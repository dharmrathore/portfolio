...
const About = () => {
    return (
        ...
        <section className='flex items-center flex-wrap md:flex-row'>
            <div className='w-full md:w-4/12 flex flex-col gap-4 border rounded-md p-4 md:p-10'>
