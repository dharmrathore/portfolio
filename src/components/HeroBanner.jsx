...
const HeroBanner = () => {
    return (
        ...
        <section className='w-full'>
            <div className='flex bg-[#f0ffff] text-[#1f436e] p-4 md:p-40 rounded-lg border w-full items-center justify-center flex-col'>
                <h1 className='text-3xl md:text-5xl lg:text-6xl uppercase font-semibold'>I'M <span className='text-transparent text-stroke'>Dev </span> Rathore</h1>
