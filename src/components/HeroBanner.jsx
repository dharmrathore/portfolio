        ...
        <section className='w-full md:py-5' id='home'>
            <div className='max-w-7xl mx-auto px-4'>
                <div className='flex bg-gray-200 bg-gradient-to-tl text-[#1f436e] p-4 py-10 md:p-36 rounded-xl border w-full items-center justify-center flex-col'>
                    <h1 className='text-xl md:text-4xl lg:text-6xl uppercase font-semibold'>I'M <span className='text-transparent text-stroke animate-pulse transition-all ease-in inline-block duration-200'>Dev </span> Rathore</h1>
