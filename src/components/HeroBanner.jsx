...
const HeroBanner = () => {
    return (
        <>
        <section className='w-full md:py-5 min-h-screen relative bg-fixed z-[1] bg-no-repeat bg-cover bg-center flex items-center justify-center before:opacity-85 before:bg-blue-500 opacity-45 before:w-full before:h-full before:absolute before:top-0 before:left-0' id='home'  style={{ backgroundImage: "url('images/bg-hero.jpg')" }}>
